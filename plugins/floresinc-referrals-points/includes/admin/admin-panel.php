 ...
 */
function floresinc_rp_init_admin_panel() {
    // Registrar configuraciones
    add_action('admin_init', 'floresinc_rp_register_panel_settings');
    ...
    add_action('personal_options_update', 'floresinc_rp_panel_save_user_profile_fields');
    add_action('edit_user_profile_update', 'floresinc_rp_panel_save_user_profile_fields');
 ...
 * @deprecated Esta función está comentada para evitar duplicación con floresinc_rp_register_admin_menu()
 */
/*
function floresinc_rp_admin_menu() {
    ...
    add_submenu_page(
        ...
        'floresinc_rp_panel_settings_page'
    );
    ...
    add_submenu_page(
        ...
        'floresinc_rp_panel_transactions_page'
    );
    ...
    add_submenu_page(
        ...
        'floresinc_rp_panel_network_page'
    );
}
*/
 ...
 */
function floresinc_rp_register_panel_settings() {
 ...
 */
function floresinc_rp_panel_settings_page() {
    ?>
    <div class="wrap">
 ...
 */
function floresinc_rp_panel_transactions_page() {
...
/**
 * Página de red de referidos del panel
 */
function floresinc_rp_panel_network_page() {
    // Incluir clase de listado de tabla WP
    if (!class_exists('WP_List_Table')) {
        require_once(ABSPATH . 'wp-admin/includes/class-wp-list-table.php');
    }
...
/**
 * Guardar campos personalizados del perfil de usuario en el panel
 */
function floresinc_rp_panel_save_user_profile_fields($user_id) {
    if (!current_user_can('manage_options')) {
        return;
    }
