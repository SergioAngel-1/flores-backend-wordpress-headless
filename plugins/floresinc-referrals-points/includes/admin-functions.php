...
function floresinc_rp_dashboard_page() {
    ...
    // Incluir vista
    include_once FLORESINC_RP_DIR . 'views/admin-dashboard.php';
    
    // Cerrar el div.wrap
    echo '</div>';
    
    // Añadir estilos para las pestañas
    ?>
    <style type="text/css">
        .floresinc-rp-tabs {
            display: flex;
        ...
        .floresinc-rp-tabs .tab:hover {
            background-color: #e5e5e5;
        }
        
        .floresinc-rp-tabs .tab.active:hover {
            background-color: #fff;
        }
    </style>
    <?php
...
function floresinc_rp_network_page() {
    ...
    <style type="text/css">
        ...
        .floresinc-rp-network-stats {
            display: flex;
            margin-bottom: 20px;
        }
        
        .floresinc-rp-network-stats .stat-box {
            flex: 1;
            margin-right: 15px;
            padding: 15px;
        ...
        .floresinc-rp-network-stats .stat-box:last-child {
            margin-right: 0;
        }
        
        .floresinc-rp-network-stats .stat-label {
            display: block;
            margin-bottom: 5px;
            font-weight: bold;
            color: #555;
        ...
        .floresinc-rp-network-stats .stat-value {
            display: block;
            font-size: 24px;
            font-weight: bold;
            color: #0073aa;
...
function floresinc_rp_settings_page() {
    ...
    // Incluir vista
    include_once FLORESINC_RP_DIR . 'views/admin-settings.php';
}
